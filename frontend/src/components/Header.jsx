    ...
    <header className="shadow-md">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 sm:px-8">
        <Link to="/" className="flex items-center">
          <img
            className="h-10"
            src="https://cdn.iconscout.com/icon/free/png-512/free-airbnb-icon-download-in-svg-png-gif-file-formats--logo-logos-pack-icons-735046.png?f=webp&w=256"
            alt="Logo do airbnb"
          />
        ...
        >
          ...
          <p className="max-w-20 truncate sm:max-w-32">Vinicius NN</p>
        </Link>
      </div>
    </header>
  );
